...
![动静分离](../images/dynamic-static.png)
...
![动静分离](../images/dynamic-static2.png)
...
![高可用](../images/high-availability.png)
...
![master&worker](../images/nginx-process.png)

**master 进程和 worker 进程：**

![master&worker](../images/master-worker.png)
